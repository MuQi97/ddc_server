                    ...
                    success: function (res) {
                        ...
                        laytpl(getTpl).render(data, function (html) {
                            ...
                            for(var i=0; i<data.data.length; i++){
                                var d = data.data[i];
                                console.log(d.image);
                                $('#moreImages').append('<div><img src="'+ d.image +'" alt="'+ data.name +'" class="avatar size-XL l layui-upload-img" style="padding-left:5px;margin-top:30px;"></div>');
                                $('#moreImages').append('<div class="checkbox" style="position:absolute;top:0;right:0;z-index:1000" id="delImage"><input id="d.id" type="checkbox" name="delImage"></div>')
                            }
                        });
                    }
                })
